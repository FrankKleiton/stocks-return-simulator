      ...
      <form action={submit}>
        <Stack gap="sm">
          <SimpleGrid cols={{ base: 1, sm: 2, lg: 1 }} spacing="sm">
            <TextInput label="Start date" name="startDate" type="date" defaultValue="2014-01-01"/>
            <TextInput label="End date" name="endDate" type="date" defaultValue={new Date().toISOString().slice(0,10)}/>
            <NumberInput label="Initial investment" name="initialInvestment" defaultValue={10000} min={0}/>
            <NumberInput label="Monthly contribution" name="monthlyContribution" defaultValue={500} min={0}/>
          </SimpleGrid>
          <Select label="Dividends" name="dividendMode" defaultValue="reinvest" data={dividendModeOptions}/>
